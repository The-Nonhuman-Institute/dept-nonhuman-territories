...
# ---------------------------------------------------------------------------
# GOVERNING CONDITIONS — retrofitted to BASIN-03 at shift 153, by steward decision
#
...
TEMPERATURE_LAPSE = 14.0         # degrees lost across the full elevation range
TEMPERATURE_CYCLE_SWING = 9.0    # degrees the light cycle carries with it
...
GRAVITY = 1.00                   # BASIN-03 keeps the reference value
